        ...
        <div className="relative">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-4">Want to See the Technical Details?</h3>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Dive deep into our Voice AI architecture and discover the sophisticated technology stack 
                that powers these intelligent conversations.
              </p>
              <a 
                href="/voice-ai-architecture" 
...
// Voice Agent Infographic Section Component
const VoiceAgentInfographic = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the advanced technology stack powering our intelligent voice agents
          </p>
        </div>
              ...
              <div key={step.id} className="relative">
                ...
                >
                  ...
                  <div className="flex flex-col items-center mb-4">
                    ...
                    <div className="bg-gray-700 text-cyan-400 px-3 py-1 rounded-full text-xs font-medium">
                      {step.tech}
                    </div>
                  </div>
